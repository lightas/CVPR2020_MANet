...
########
        optimizer = optim.SGD(param_list,lr=cfg.TRAIN_LR,momentum=cfg.TRAIN_MOMENTUM,weight_decay=cfg.TRAIN_WEIGHT_DECAY,nesterov=True)
        ...
        with torch.no_grad():
            for seq_name in seqs:
                ...
                for ii,sample in enumerate(test_dataloader):
                    ...
                    tmp_dic = self.model.prop_seghead(ref_frame_embedding,previous_frame_embedding,
