...
##############################################################
#def select_prev_label(prev_frame_embedding,prev_frame_label,obj_ids,select_percent=cfg.MODEL_SELECT_PERCENT):
    
def select_prev_attenhead(prev_frame_embedding,prev_frame_label,obj_ids,select_percent=cfg.MODEL_SELECT_PERCENT,chunk=100):
...
class DynamicSegHead(nn.Module):
    def __init__(self,in_dim=(cfg.MODEL_SEMANTIC_EMBEDDING_DIM+4),embed_dim=cfg.MODEL_HEAD_EMBEDDING_DIM,kernel_size=1,siamese_atten=cfg.MODEL_SIAMESE_ATTETION):
...
###                                                          dilate=False)
           ...
           # #########################
            ...
            to_cat = torch.cat((to_cat_current_frame_embedding,to_cat_nn_feature_n,to_cat_prev_frame_nn_feature_n,to_cat_atten_map,to_cat_previous_frame),1)
