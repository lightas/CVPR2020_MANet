...
from networks_old.sync_batchnorm import SynchronizedBatchNorm2d

bn_mom = 0.0003
__all__ = ['xception']

model_urls = {
    'xception': '../../model/xception_pytorch_imagenet.pth'#'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
}
